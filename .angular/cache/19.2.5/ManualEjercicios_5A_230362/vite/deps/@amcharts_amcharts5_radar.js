import {
  ...
  XYChart,
  XYCursor
} from "./chunk-4CHNJD2S.js";
import "./chunk-PUPBNNZI.js";
import {
  Slice
...
var AxisRendererRadial = class extends AxisRenderer {
  ...
  positionToPoint(position) {
    ...
    const axisAngle = this.get("axisAngle", 0);
    return {
      x: radius * cos(axisAngle),
      y: radius * sin(axisAngle)
    };
  }
  /**
   * @ignore
    ...
    if (mask) {
      mask.set("draw", (display) => {
        ...
        this._arcGenerator({
          ...
          startAngle: (this.get("startAngle", 0) + 90) * RADIANS,
          endAngle: (this.get("endAngle", 0) + 90) * RADIANS
        });
      });
    }
  }
