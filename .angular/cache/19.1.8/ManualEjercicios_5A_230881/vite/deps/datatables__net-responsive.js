import {
  dataTables_default
} from "./chunk-3JEI5ST7.js";
import {
  require_jquery
} from "./chunk-PHFJGH2T.js";
import {
  __toESM
...
var Responsive = function(settings, opts) {
  ...
  this.c = $.extend(true, {}, Responsive.defaults, dataTables_default.defaults.responsive, opts);
...
$.extend(Responsive.prototype, {
  ...
  _constructor: function() {
    ...
    $(window).on("orientationchange.dtr", dataTables_default.util.throttle(function() {
    ...
    var fn = function(api, rowIdx, columns) {
      ...
      $.each(columns, function(i, col) {
        if (col.hidden) {
          ...
          $("<li " + klass + ' data-dtr-index="' + col.columnIndex + '" data-dt-row="' + col.rowIndex + '" data-dt-column="' + col.columnIndex + '"><span class="dtr-title">' + col.title + "</span> </li>").append($('<span class="dtr-data"/>').append(that._childNodes(api, col.rowIndex, col.columnIndex))).appendTo(ul);
          found = true;
        }
      });
