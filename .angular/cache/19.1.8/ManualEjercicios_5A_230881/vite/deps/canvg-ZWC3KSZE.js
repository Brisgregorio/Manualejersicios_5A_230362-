...
var require_object_property_is_enumerable = __commonJS({
  "node_modules/core-js/internals/object-property-is-enumerable.js"(exports) {
    ...
    var NASHORN_BUG = getOwnPropertyDescriptor5 && !$propertyIsEnumerable.call({
      1: 2
    }, 1);
...
var require_ordinary_to_primitive = __commonJS({
  "node_modules/core-js/internals/ordinary-to-primitive.js"(exports, module) {
    ...
    module.exports = function(input, pref) {
      var fn, val;
      if (pref === "string" && isCallable3(fn = input.toString) && !isObject4(val = call4(fn, input))) return val;
      if (isCallable3(fn = input.valueOf) && !isObject4(val = call4(fn, input))) return val;
      if (pref !== "string" && isCallable3(fn = input.toString) && !isObject4(val = call4(fn, input))) return val;
...
var require_define_global_property = __commonJS({
  "node_modules/core-js/internals/define-global-property.js"(exports, module) {
    ...
    module.exports = function(key, value) {
      try {
        defineProperty2(globalThis6, key, {
          value,
          configurable: true,
          writable: true
        });
...
var require_to_primitive = __commonJS({
  "node_modules/core-js/internals/to-primitive.js"(exports, module) {
    ...
    module.exports = function(input, pref) {
      if (!isObject4(input) || isSymbol2(input)) return input;
      var exoticToPrim = getMethod4(input, TO_PRIMITIVE);
      var result;
      if (exoticToPrim) {
        if (pref === void 0) pref = "default";
        result = call4(exoticToPrim, input, pref);
        if (!isObject4(result) || isSymbol2(result)) return result;
        throw new $TypeError("Can't convert object to primitive value");
      }
...
var require_object_get_own_property_descriptor = __commonJS({
  "node_modules/core-js/internals/object-get-own-property-descriptor.js"(exports) {
    ...
    exports.f = DESCRIPTORS6 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor5(O, P) {
      ...
      if (hasOwn3(O, P)) return createPropertyDescriptor(!call4(propertyIsEnumerableModule.f, O, P), O[P]);
    };
  }
});
  ...
  "node_modules/core-js/internals/make-built-in.js"(exports, module) {
    ...
    var makeBuiltIn = module.exports = function(value, name, options) {
      ...
      if (!hasOwn3(value, "name") || CONFIGURABLE_FUNCTION_NAME && value.name !== name) {
        if (DESCRIPTORS6) defineProperty2(value, "name", {
          value: name,
          configurable: true
        });
      ...
      try {
        if (options && hasOwn3(options, "constructor") && options.constructor) {
          if (DESCRIPTORS6) defineProperty2(value, "prototype", {
            writable: false
          });
...
var require_function_uncurry_this_clause = __commonJS({
  "node_modules/core-js/internals/function-uncurry-this-clause.js"(exports, module) {
    ...
    module.exports = function(fn) {
      if (classofRaw(fn) === "Function") return uncurryThis11(fn);
    };
  }
});
  ...
  "node_modules/core-js/modules/es.symbol.constructor.js"() {
    ...
    var $defineProperties = function defineProperties(O, Properties) {
      ...
      $forEach(keys2, function(key) {
        if (!DESCRIPTORS6 || call4($propertyIsEnumerable, properties, key)) $defineProperty(O, key, properties[key]);
      });
      return O;
    };
    ...
    if (!NATIVE_SYMBOL) {
      $Symbol = function Symbol2() {
        ...
        var setter = function(value) {
          ...
          if ($this === ObjectPrototype2) call4(setter, ObjectPrototypeSymbols, value);
        ...
        if (DESCRIPTORS6 && USE_SETTER) setSymbolDescriptor(ObjectPrototype2, tag, {
          configurable: true,
          set: setter
        });
      ...
      if (DESCRIPTORS6) {
        ...
        if (!IS_PURE3) {
          defineBuiltIn3(ObjectPrototype2, "propertyIsEnumerable", $propertyIsEnumerable, {
            unsafe: true
          });
        }
      }
  ...
  "node_modules/core-js/modules/es.json.stringify.js"() {
    ...
    var stringifyWithSymbolsFix = function(it, replacer) {
      ...
      args[1] = function(key, value) {
        if (isCallable3($replacer)) value = call4($replacer, this, $String(key), value);
...
var require_es_promise_constructor = __commonJS({
  "node_modules/core-js/modules/es.promise.constructor.js"() {
    ...
    var onUnhandled = function(state) {
      call4(task, globalThis6, function() {
      ...
      try {
        ...
        if (then) {
          microtask(function() {
            ...
            try {
              call4(then, value, bind2(internalResolve, wrapper, state), bind2(internalReject, wrapper, state));
            } catch (error) {
...
var require_get_iterator = __commonJS({
  "node_modules/core-js/internals/get-iterator.js"(exports, module) {
    ...
    module.exports = function(argument, usingIterator) {
      ...
      if (aCallable2(iteratorMethod)) return anObject9(call4(iteratorMethod, argument));
  ...
  "node_modules/core-js/modules/es.promise.catch.js"() {
    ...
    if (!IS_PURE3 && isCallable3(NativePromiseConstructor)) {
      ...
      if (NativePromisePrototype["catch"] !== method) {
        defineBuiltIn3(NativePromisePrototype, "catch", method, {
          unsafe: true
        });
      }
    }
      ...
      this.getHelpXML = function() {
        ...
        for (var i2 = 0; i2 < examples.length; i2++) {
          try {
            ...
            var list_item_value = document.createTextNode(" " + examples[i2] + " -> " + list_color.toRGB() + " -> " + list_color.toHex());
  ...
  "node_modules/core-js/internals/iterator-define.js"(exports, module) {
    ...
    module.exports = function(Iterable, NAME2, IteratorConstructor, next2, DEFAULT, IS_SET, FORCED8) {
      ...
      if ((!IS_PURE3 || FORCED8) && IterablePrototype[ITERATOR2] !== defaultIterator) {
        defineBuiltIn3(IterablePrototype, ITERATOR2, defaultIterator, {
          name: DEFAULT
        });
      }
  ...
  "node_modules/core-js/internals/collection.js"(exports, module) {
    ...
    module.exports = function(CONSTRUCTOR_NAME, wrapper, common) {
      ...
      var fixMethod = function(KEY) {
        ...
        defineBuiltIn3(NativePrototype, KEY, KEY === "add" ? function add(value) {
      ...
      var REPLACE2 = isForced2(CONSTRUCTOR_NAME, !isCallable3(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails11(function() {
      ...
      if (REPLACE2) {
        ...
        if (!ACCEPT_ITERABLES) {
          Constructor = wrapper(function(dummy, iterable) {
            ...
            if (!isNullOrUndefined4(iterable)) iterate(iterable, that[ADDER], {
              that,
              AS_ENTRIES: IS_MAP
            });
            return that;
...
if (!TO_STRING_TAG_SUPPORT) {
  defineBuiltIn(Object.prototype, "toString", toString4, {
    unsafe: true
  });
}
...
$16({
  ...
  includes: function includes2(searchString) {
    return !!~stringIndexOf2(toString6(requireObjectCoercible5(this)), toString6(notARegExp2(searchString)), arguments.length > 1 ? arguments[1] : void 0);
  }
});
...
*/
//# sourceMappingURL=canvg-ZWC3KSZE.js.map
